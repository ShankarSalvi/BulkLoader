...
START_BUTTONS=[
    [
        InlineKeyboardButton("Source", url="https://t.me/amit_0211"),
        InlineKeyboardButton("Project Channel", url="https://t.me/amit_0211"),
    ],
    [InlineKeyboardButton("Author", url="https://t.me/amit_0211")],
]
...
async def linkloader(bot, update):
    xlink = await update.reply_text(f"Send your links, separated each link by new line", timeout=300)
    if BUTTONS == True:
